...
class PreferencesManager(context: Context) {
    ...
    fun getEpaSystemNumber(zipCode: String, enabled: Boolean): String {
        ...
        return when (zipCode.take(5)) {
            ...
            "62565" -> "IL0211100" // Shelbyville
            "62468" -> "IL0211100" // Stewardson & Strasburg (supplied by Shelbyville)
            ...
            "61554" -> "IL1814620" // Morton
            "61571" -> "IL1814720" // Washington
            "61611" -> "IL1814320" // East Peoria
            "61602", "61603", "61604", "61605", "61606", "61614", "61615"
                -> "IL1430010" // Peoria (Illinois American Water)
            "61550" -> "IL1430010" // Metamora (supplied by Illinois American Water)
            "61530" -> "IL1430010" // Eureka (supplied by Illinois American Water)
            ...
            "61820", "61821", "61822" -> "IL0190010" // Champaign & Urbana (Illinois American Water)
            "61874" -> "IL0190010" // Savoy (supplied by Illinois American Water)
            ...
            else -> "Contact IL EPA at (217) 782-1020 for Water System Number"
        }
    }
}
